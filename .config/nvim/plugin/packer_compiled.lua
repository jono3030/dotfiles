...
_G.packer_plugins = {
  ["barbar.nvim"] = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/barbar.nvim",
  ...
  ["hop.nvim"] = {
    ...
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/hop.nvim",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
